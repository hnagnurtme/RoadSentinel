...
class AlertOverviewView(PGView):
    ...
    SELECT
        ...
        u._created_at AS user___created_at,
        u._updated_at AS user___updated_at,
        u._deleted_at AS user___deleted_at,
        ...
        v._created_at AS vehicle___created_at,
        v._updated_at AS vehicle___updated_at,
        v._deleted_at AS vehicle___deleted_at,
